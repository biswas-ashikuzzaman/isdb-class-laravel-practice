		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Admin Dashboard</span>
              ...
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">View All Accounts</span>
					...
					<li class="sidebar-item {{request()->routeIs('vendor.usermanagement.user_account_status')?'active':''}}">
						<a class="sidebar-link" href="{{route('vendor.usermanagement.user_account_status')}}">
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">User Account Status</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">User Verification</span>
            </a>
					</li>
