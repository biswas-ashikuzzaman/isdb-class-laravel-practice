            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left">
                        <a href="tel:#"><i class="icon-phone"></i>Call: +8801910192276</a>
                    </div><!-- End .header-left -->
                                            ...
                                            <div class="col-md-4">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html" class="banner banner-menu">
                                                        <img src="{{ asset('front_end_asset/') }}/assets/images/menu/banner-1.jpg" alt="Banner">
                                            ...
                                            <div class="col-md-6">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html">
                                                        <img src="{{ asset('front_end_asset/') }}/assets/images/menu/banner-2.jpg" alt="Banner">
