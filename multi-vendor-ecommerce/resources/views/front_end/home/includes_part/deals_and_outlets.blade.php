 <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style="background-image: url('{{ asset('front_end_asset/assets/images/demos/demo-4/deal/bg-1.jpg') }}');">
                            <div class="deal-top">
                    ...
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style="background-image: url('{{ asset('front_end_asset/assets/images/demos/demo-4/deal/bg-2.jpg')}}');">
                            <div class="deal-top">
