<div class="intro-slider-container mb-5">
                <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" 
                    ...
                    <div class="intro-slide" style="background-image: url('{{ asset('front_end_asset/assets/images/demos/demo-4/slider/slide-1.png') }}');">
                    ...
                    <div class="intro-slide" style="background-image: url('{{asset('front_end_asset/assets/images/demos/demo-4/slider/slide-2.png')}}');">
                        <div class="container intro-content">
                            <div class="row justify-content-end">
                                <div class="col-auto col-sm-7 col-md-6 col-lg-5">
